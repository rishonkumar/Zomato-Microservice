    ...
    return (
        <div className='w-full bg-white shadow-sm'>
            <div className='mx-auto flex max-w-7xl items-center justify-between px-4 py-3'>
                <Link to={"/"} className='text-2xl font-bold text-[#E23744] cursor-pointer'>Zomatao</Link>
            ...
            {/* search bar */}
            {
                isHomePage && (<div className='border-t py-3 px-4'>
                    <div className='mx-auto flex max-w-7xl items-center rounded-lg border shadow-sm'>
                        ...
                        <div className=' flex flex-1 items-center gap-2 px-3'> <BiSearch className='h-4 w-4 text-gray-400' />
                            <input type='text' placeholder='Search for res' value={search} onChange={e => setSearch(e.target.value)}
