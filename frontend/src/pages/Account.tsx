...
const Account = () => {
    ...
    const { user, setUser, setIsAuth } = userAppData()
        ...
        <div className="min-h-screen bg-gray-50 px-4 py-6">
            <div className="mx-auto max-w-md rounded-lg bg-white shadow-sm">
                ...
                <div className="divide-y">
                    <div className="flex cursor-pointer items-center gap-4 p-5 hover:bg-gray-500" onClick={() => navigate('/orders')}>
                        <BiPackage className="h-5 w-5 text-red-500" />
                        <span className="font-medium">Your Orders</span>
                    </div>
                    <div className="flex cursor-pointer items-center gap-4 p-5 hover:bg-gray-500" onClick={() => navigate('/address')}>
                        <BiMapPin className="h-5 w-5 text-red-500" />
                        <span className="font-medium">Address</span>
                    </div>
                    <div className="flex cursor-pointer items-center gap-4 p-5 hover:bg-gray-500" onClick={logoutHandler}>
